...
object FiberPillApp
  ...
  /** Fiber creation demo. The main entry point of the application. It creates a
    * list of ProcessInput instances, forks fibers to process them and waits for
    * all fibers to complete.
    */
  def run: UIO[Unit] =
    val inputs = List
